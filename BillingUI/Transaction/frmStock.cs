...
namespace AC.Billing.UI.Transaction
{
    public partial class frmStock : BaseClass
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (validation() == true)
            {
                stockBLL.StockSave(stockID, Convert.ToInt32(cmbProduct.SelectedValue.ToString()), txtMake.Text.Trim(),Convert.ToInt32(txtQuantity.Text), Convert.ToInt32(cbUnit.SelectedValue.ToString())
