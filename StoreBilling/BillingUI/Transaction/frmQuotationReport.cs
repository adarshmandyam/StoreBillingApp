...
{
    public partial class frmQuotationReport : BaseClass
    {
        ...
        private void FillGrid()
        {
            ...
            dt = quotationBLL.GetQuotationReport(Convert.ToDateTime(txtStartDate.Text.Trim()), Convert.ToDateTime(txtEndDate.Text.Trim()));
            GridBind(dt);
        }
