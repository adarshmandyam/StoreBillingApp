...
{
    public partial class frmInventryReport : BaseClass
    {
        ...
        private void FillGrid()
        {
            ...
            dt = inventoryBLL.GetInventoryReport(Convert.ToDateTime(txtStartDate.Text.Trim()), Convert.ToDateTime(txtEndDate.Text.Trim()));
            GridBind(dt);
        }
        ...
        private void frmInventryReport_Load(object sender, EventArgs e)
        {
